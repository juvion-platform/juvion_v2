...
export async function listConversations(req: AuthRequest, res: Response, next: NextFunction) {
  try { res.json(await service.listConversations(req.collegeId!, Number(req.query.page) || 1, Number(req.query.limit) || 20, req.authScope)); } catch (err) { next(err); }
}
...
export async function listMessages(req: AuthRequest, res: Response, next: NextFunction) {
  try {
    ...
    res.json(await service.listMessages(req.collegeId!, Number(page) || 1, Number(limit) || 20, conversationId, req.authScope));
  } catch (err) { next(err); }
}
...
export async function listActions(req: AuthRequest, res: Response, next: NextFunction) {
  try {
    const { page, limit, conversationId } = req.query as any;
    res.json(await service.listActions(req.collegeId!, Number(page) || 1, Number(limit) || 20, conversationId, req.authScope));
  } catch (err) { next(err); }
}
...
export async function listInsights(req: AuthRequest, res: Response, next: NextFunction) {
  try {
    ...
    res.json(await service.listInsights(req.collegeId!, Number(page) || 1, Number(limit) || 20, type, status, req.authScope));
  } catch (err) { next(err); }
}
...
export async function listKnowledgeBase(req: AuthRequest, res: Response, next: NextFunction) {
  try {
    ...
    res.json(await service.listKnowledgeBase(req.collegeId!, Number(page) || 1, Number(limit) || 20, category, req.authScope));
  } catch (err) { next(err); }
}
...
export async function listPersonaConfigs(req: AuthRequest, res: Response, next: NextFunction) {
  try { res.json(await service.listPersonaConfigs(req.collegeId!, Number(req.query.page) || 1, Number(req.query.limit) || 20, req.authScope)); } catch (err) { next(err); }
}
...
export async function listFeedback(req: AuthRequest, res: Response, next: NextFunction) {
  try { res.json(await service.listFeedback(req.collegeId!, Number(req.query.page) || 1, Number(req.query.limit) || 20, req.authScope)); } catch (err) { next(err); }
}
...
export async function listUsageMetrics(req: AuthRequest, res: Response, next: NextFunction) {
  try {
    ...
    res.json(await service.listUsageMetrics(req.collegeId!, Number(page) || 1, Number(limit) || 20, personaType, req.authScope));
  } catch (err) { next(err); }
}
