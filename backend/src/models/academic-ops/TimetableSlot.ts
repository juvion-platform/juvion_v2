...
export interface ITimetableSlot extends Document {
  ...
  substituteFacultyId?: Schema.Types.ObjectId;
  isSubstitution?: boolean;
  originalFacultyId?: Schema.Types.ObjectId;
}
...
const schema = new Schema<ITimetableSlot>({
  ...
  substituteFacultyId: { type: Schema.Types.ObjectId, ref: 'Faculty' },
  isSubstitution: { type: Boolean, default: false },
  originalFacultyId: { type: Schema.Types.ObjectId, ref: 'Faculty' },
}, { timestamps: true });
