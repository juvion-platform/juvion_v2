...
export interface IStudent extends Document {
  ...
  personId: Schema.Types.ObjectId; admissionYear: number; category?: string; quota?: string; regulationId?: Schema.Types.ObjectId; programmeId?: Schema.Types.ObjectId; branchId?: Schema.Types.ObjectId; batchId?: Schema.Types.ObjectId; rollNumber?: string; status: string;
}
