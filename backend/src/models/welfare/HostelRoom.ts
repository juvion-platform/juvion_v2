...
export interface IHostelRoom extends Document { collegeId: Schema.Types.ObjectId; blockId: Schema.Types.ObjectId; roomNumber: string; floor: number; capacity: number; occupancy: number; amenities: string[]; status: string; }
