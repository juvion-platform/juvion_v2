...
export interface IParentMeeting extends Document { collegeId: Schema.Types.ObjectId; studentId: Schema.Types.ObjectId; parentId: Schema.Types.ObjectId; facultyId: Schema.Types.ObjectId; scheduledDate: Date; agenda?: string; notes?: string; status: string; }
