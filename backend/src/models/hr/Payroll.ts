...
const schema = new Schema<IPayroll>({
  ...
  grossPay: { type: Number, sensitive: 'hr.compensation', required: true },
  pf: { type: Number, sensitive: 'hr.compensation', default: 0 },
  esi: { type: Number, sensitive: 'hr.compensation', default: 0 },
  tds: { type: Number, sensitive: 'hr.compensation', default: 0 },
  otherDeductions: { type: Number, default: 0 },
  netPay: { type: Number, sensitive: 'hr.compensation', required: true },
