...
export default function FeedbackPage() {
  ...
  const { data, isLoading } = useQuery({ queryKey: ['juvi-feedback', page, limit, search], queryFn: () => listFeedback(page, limit, search) });
    ...
    <div>
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex items-center gap-3">
          <SearchInput value={search} onChange={setSearch} placeholder="Search feedback…" className="w-56" />
      ...
      <DataTable columns={columns} data={data?.items || []} loading={isLoading} rowKey={(r: any) => r._id} onRowClick={vem.openForView}
        emptyMessage={search ? `No feedback match “${search}”.` : 'No feedback yet.'}
      />
