...
export default function JobApplicationsPage() {
  ...
  const { data, isLoading } = useQuery({ queryKey: ['job-applications', page, limit, search], queryFn: () => listJobApplications(page, limit, undefined, undefined, search) });
    ...
    <div>
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex items-center gap-3">
          <SearchInput value={search} onChange={setSearch} placeholder="Search job applications…" className="w-56" />
