...
export default function SectionsPage() {
  ...
  const createMut = useMutation({ mutationFn: createSection, onSuccess: () => { qc.invalidateQueries({ queryKey: ['sections'] }); closeModal(); } });
  ...
  const deleteMut = useMutation({ mutationFn: deleteSection, onSuccess: () => { qc.invalidateQueries({ queryKey: ['sections'] }); } });
