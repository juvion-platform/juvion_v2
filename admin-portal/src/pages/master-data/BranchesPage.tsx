...
export default function BranchesPage() {
  ...
  const createMut = useMutation({ mutationFn: createBranch, onSuccess: () => { qc.invalidateQueries({ queryKey: ['branches'] }); closeModal(); } });
  ...
  const deleteMut = useMutation({ mutationFn: deleteBranch, onSuccess: () => { qc.invalidateQueries({ queryKey: ['branches'] }); } });
