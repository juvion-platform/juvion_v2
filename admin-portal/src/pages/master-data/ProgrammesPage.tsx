...
export default function ProgrammesPage() {
  ...
  const createMut = useMutation({ mutationFn: createProgramme, onSuccess: () => { qc.invalidateQueries({ queryKey: ['programmes'] }); closeModal(); } });
  ...
  const deleteMut = useMutation({ mutationFn: deleteProgramme, onSuccess: () => { qc.invalidateQueries({ queryKey: ['programmes'] }); } });
