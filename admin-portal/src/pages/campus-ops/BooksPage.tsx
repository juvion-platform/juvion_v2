...
export default function BooksPage() {
  ...
  const { data, isLoading } = useQuery({ queryKey: ['books', page, limit, search], queryFn: () => listBooks(page, limit, search) });
    ...
    <div>
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex items-center gap-3">
          <SearchInput value={search} onChange={setSearch} placeholder="Search books…" className="w-56" />
      ...
      <DataTable columns={columns} data={data?.items||[]} loading={isLoading} rowKey={(r: any) => r._id} onRowClick={vem.openForView}
        emptyMessage={search ? `No books match “${search}”.` : 'No books yet.'}
      />
