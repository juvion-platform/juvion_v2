...
export default function WaterSupplyPage() {
  ...
  const { data, isLoading } = useQuery({ queryKey: ['water-supplies', page, limit, search], queryFn: () => listWaterSupplies(page, limit, search) });
    ...
    <div>
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex items-center gap-3">
          <SearchInput value={search} onChange={setSearch} placeholder="Search water supply…" className="w-56" />
      ...
      <DataTable columns={columns} data={data?.items||[]} loading={isLoading} rowKey={(r: any) => r._id} onRowClick={vem.openForView}
        emptyMessage={search ? `No water supply match “${search}”.` : 'No water supply yet.'}
      />
