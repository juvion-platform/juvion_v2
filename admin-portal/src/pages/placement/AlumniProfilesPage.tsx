...
export default function AlumniProfilesPage() {
  ...
  const [form, setForm] = useState({ personId: '', graduationYear: '', currentCompany: '', currentDesignation: '', location: '', linkedinUrl: '', willingToMentor: false });
  ...
  function openCreate() {
    setEditing(null);
    setForm({ personId: '', graduationYear: '', currentCompany: '', currentDesignation: '', location: '', linkedinUrl: '', willingToMentor: false });
    setModalOpen(true);
  }
  ...
  return (
    <div>
      ...
      <Modal open={modalOpen} onClose={closeModal} title={editing ? 'Edit Alumni Profile' : 'New Alumni Profile'}>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div><label className={lbl}>Person * <Link to="/people/persons" target="_blank" className={manageLink}>+ Manage <ExternalLink size={10} /></Link></label>
