...
export default function AlumniProfilesPage() {
  ...
  const { data, isLoading } = useQuery({ queryKey: ['alumni-profiles', page, limit, search], queryFn: () => listAlumniProfiles(page, limit, search) });
    ...
    <div>
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex items-center gap-3">
          <SearchInput value={search} onChange={setSearch} placeholder="Search alumni profiles…" className="w-56" />
