...
export default function TrainingAttendancePage() {
  ...
  const { data, isLoading } = useQuery({ queryKey: ['training-attendance', page, limit, search], queryFn: () => listTrainingAttendance(page, limit, undefined, search) });
    ...
    <div>
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex items-center gap-3">
          <SearchInput value={search} onChange={setSearch} placeholder="Search training attendance…" className="w-56" />
