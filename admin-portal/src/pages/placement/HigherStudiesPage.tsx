...
export default function HigherStudiesPage() {
  ...
  const { data, isLoading } = useQuery({ queryKey: ['higher-studies', page, limit, search], queryFn: () => listHigherStudiesApplications(page, limit, undefined, search) });
    ...
    <div>
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex items-center gap-3">
          <SearchInput value={search} onChange={setSearch} placeholder="Search higher studies applications…" className="w-56" />
