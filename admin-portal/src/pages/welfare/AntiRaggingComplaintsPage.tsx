...
export default function AntiRaggingComplaintsPage() {
  ...
  const { data, isLoading } = useQuery({ queryKey: ['anti-ragging-complaints', page, limit, search], queryFn: () => listAntiRaggingComplaints(page, limit, undefined, search) });
    ...
    <div>
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex items-center gap-3">
          <SearchInput value={search} onChange={setSearch} placeholder="Search anti-ragging complaints…" className="w-56" />
