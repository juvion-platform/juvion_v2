...
export default function MeetingsPage() {
  ...
  const { data, isLoading } = useQuery({ queryKey: ['gov-meetings', page, limit, search], queryFn: () => listMeetings(page, limit, undefined, undefined, search) });
    ...
    <div>
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex items-center gap-3">
          <SearchInput value={search} onChange={setSearch} placeholder="Search committee meetings…" className="w-56" />
      ...
      <DataTable
        ...
        emptyMessage={search ? `No committee meetings match “${search}”.` : 'No committee meetings yet.'}
      />
