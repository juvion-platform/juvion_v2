...
export default function ProgrammesPage() {
  ...
  const createMut = useMutation({ mutationFn: createProgramme, onSuccess: () => { qc.invalidateQueries({ queryKey: ['programmes'] }); qc.invalidateQueries({ queryKey: ['academics-stats'] }); vem.close(); } });
  const updateMut = useMutation({ mutationFn: ({ id, data }: any) => updateProgramme(id, data), onSuccess: () => { qc.invalidateQueries({ queryKey: ['programmes'] }); vem.close(); } });
