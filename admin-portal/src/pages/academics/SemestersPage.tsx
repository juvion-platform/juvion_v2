...
export default function SemestersPage() {
  ...
  const createMut = useMutation({ mutationFn: createSemester, onSuccess: () => { qc.invalidateQueries({ queryKey: ['semesters'] }); qc.invalidateQueries({ queryKey: ['academics-stats'] }); closeModal(); } });
