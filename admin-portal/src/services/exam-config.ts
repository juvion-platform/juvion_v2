...
// ─── ExamRoom ─────────────────────────────────────────────────────
export const listExamRooms = (page = 1, limit = 20, status?: string) =>
  api.get(`${BASE}/rooms`, { params: { page, limit, status } }).then((r) => r.data as PaginatedResponse<any>);
...
// ─── Evaluator ────────────────────────────────────────────────────
export const listEvaluators = (page = 1, limit = 20, status?: string, kind?: string) =>
  api.get(`${BASE}/evaluators`, { params: { page, limit, status, kind } }).then((r) => r.data as PaginatedResponse<any>);
...
// ─── GradeTemplate ────────────────────────────────────────────────
export const listGradeTemplates = (page = 1, limit = 20) =>
  api.get(`${BASE}/grade-templates`, { params: { page, limit } }).then((r) => r.data as PaginatedResponse<any>);
...
// ─── ExamCentreTemplate ───────────────────────────────────────────
export const listExamCentreTemplates = (page = 1, limit = 20) =>
  api.get(`${BASE}/centre-templates`, { params: { page, limit } }).then((r) => r.data as PaginatedResponse<any>);
...
// ─── QuestionPaperSchema ──────────────────────────────────────────
export const listQuestionPapers = (page = 1, limit = 20, status?: string) =>
  api.get(`${BASE}/question-papers`, { params: { page, limit, status } }).then((r) => r.data as PaginatedResponse<any>);
...
// ─── MoocSubject ──────────────────────────────────────────────────
export const listMoocSubjects = (page = 1, limit = 20, status?: string) =>
  api.get(`${BASE}/mooc-subjects`, { params: { page, limit, status } }).then((r) => r.data as PaginatedResponse<any>);
