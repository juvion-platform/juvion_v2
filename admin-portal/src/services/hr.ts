...
// ─── Employees ────────────────────────────────────────────
export const listEmployees = (page = 1, limit = 20, departmentId?: string, status?: string) =>
  api.get(`${BASE}/employees`, { params: { page, limit, departmentId, status } }).then(r => r.data);
...
// ─── Leave Types ──────────────────────────────────────────
export const listLeaveTypes = (page = 1, limit = 20) =>
  api.get(`${BASE}/leave-types`, { params: { page, limit } }).then(r => r.data);
...
// ─── Leave Balances ───────────────────────────────────────
export const listLeaveBalances = (page = 1, limit = 20, employeeId?: string, academicYearId?: string) =>
  api.get(`${BASE}/leave-balances`, { params: { page, limit, employeeId, academicYearId } }).then(r => r.data);
...
// ─── Employee Attendance ──────────────────────────────────
export const listEmployeeAttendance = (page = 1, limit = 20, employeeId?: string) =>
  api.get(`${BASE}/employee-attendance`, { params: { page, limit, employeeId } }).then(r => r.data);
...
// ─── Pay Structures ──────────────────────────────────────
export const listPayStructures = (page = 1, limit = 20, employeeId?: string) =>
  api.get(`${BASE}/pay-structures`, { params: { page, limit, employeeId } }).then(r => r.data);
...
// ─── Payrolls ─────────────────────────────────────────────
export const listPayrolls = (page = 1, limit = 20, employeeId?: string, month?: string, year?: string) =>
  api.get(`${BASE}/payroll`, { params: { page, limit, employeeId, month, year } }).then(r => r.data);
...
// ─── Appraisals ──────────────────────────────────────────
export const listAppraisals = (page = 1, limit = 20, employeeId?: string, academicYearId?: string) =>
  api.get(`${BASE}/appraisals`, { params: { page, limit, employeeId, academicYearId } }).then(r => r.data);
...
// ─── Promotions ───────────────────────────────────────────
export const listPromotions = (page = 1, limit = 20, employeeId?: string) =>
  api.get(`${BASE}/promotions`, { params: { page, limit, employeeId } }).then(r => r.data);
...
// ─── Trainings ────────────────────────────────────────────
export const listTrainings = (page = 1, limit = 20, status?: string) =>
  api.get(`${BASE}/trainings`, { params: { page, limit, status } }).then(r => r.data);
...
export const listTrainingParticipants = (page = 1, limit = 20, trainingId?: string) =>
  api.get(`${BASE}/training-participants`, { params: { page, limit, trainingId } }).then(r => r.data);
...
// ─── Qualifications ──────────────────────────────────────
export const listQualifications = (page = 1, limit = 20, personId?: string) =>
  api.get(`${BASE}/qualifications`, { params: { page, limit, personId } }).then(r => r.data);
...
// ─── Grievances ───────────────────────────────────────────
export const listGrievances = (page = 1, limit = 20, status?: string) =>
  api.get(`${BASE}/grievances`, { params: { page, limit, status } }).then(r => r.data);
...
// ─── On Duty ──────────────────────────────────────────────
export const listOnDuty = (page = 1, limit = 20, employeeId?: string) =>
  api.get(`${BASE}/on-duty`, { params: { page, limit, employeeId } }).then(r => r.data);
...
// ─── Exit Processes ───────────────────────────────────────
export const listExitProcesses = (page = 1, limit = 20, employeeId?: string) =>
  api.get(`${BASE}/exit-processes`, { params: { page, limit, employeeId } }).then(r => r.data);
...
// ─── Recruitments ─────────────────────────────────────────
export const listRecruitments = (page = 1, limit = 20, status?: string) =>
  api.get(`${BASE}/recruitments`, { params: { page, limit, status } }).then(r => r.data);
...
// ─── Job Applications ────────────────────────────────────
export const listJobApplications = (page = 1, limit = 20, recruitmentId?: string, status?: string) =>
  api.get(`${BASE}/job-applications`, { params: { page, limit, recruitmentId, status } }).then(r => r.data);
...
// ─── Publications ─────────────────────────────────────────
export const listPublications = (page = 1, limit = 20, facultyId?: string) =>
  api.get(`${BASE}/publications`, { params: { page, limit, facultyId } }).then(r => r.data);
...
// ─── Research Projects ───────────────────────────────────
export const listResearchProjects = (page = 1, limit = 20, principalInvestigatorId?: string) =>
  api.get(`${BASE}/research-projects`, { params: { page, limit, principalInvestigatorId } }).then(r => r.data);
